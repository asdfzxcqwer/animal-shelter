...
function Register() {
    ...
    const onSubmit = async (e) => {
        e.preventDefault()
        await axios.post("http://localhost:8085/api/v1/authorization/register", user)
            .then(response => {
    ...
    return (
       <div class="d-flex justify-content-center" style={{ minHeight: "105vh", backgroundColor: " #937147", textAlign: 'center' }}>
       <div class="d-flex justify-content-center" style={{ minHeight: "20vh", backgroundColor: " #937147", textAlign: 'center' }}>  </div>
        <div className="center"  style={{ minHeight: "83vh", backgroundColor: "white", textAlign: 'center' }} >
                <h1>Register</h1>
